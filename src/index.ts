...
import { RawResponse, Sentence, TranslateOptions, TranslateResult } from './types.js';
...
export class Translator {
  ...
  protected buildFetchOptions(): RequestInit {
    const { fetchOptions } = this.options;
    const res = Object.assign({}, fetchOptions) as RequestInit;
    res.method = 'POST';
